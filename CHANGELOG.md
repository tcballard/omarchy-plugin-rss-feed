...
Opening and floating were confirmed on the maintainer’s XPS before the hardening pass. See `docs/validation.md` for portable evidence and the remaining on-device release checks. No tagged release has been published. [Prepared release notes](docs/releases/v0.1.0.md) include the original screenshot and installation instructions.
